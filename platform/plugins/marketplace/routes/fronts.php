...
Route::group([
    ...
    Theme::registerRoutes(function () {
        ...
        Route::group([
            ...
            Route::middleware([CheckProductSpecificationEnabledMiddleware::class])->group(function () {
        ...
        Route::middleware('customer')->prefix('customer/become-vendor')->name('marketplace.vendor.')->group(function () {
